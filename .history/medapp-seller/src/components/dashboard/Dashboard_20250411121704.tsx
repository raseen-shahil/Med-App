...
const navigationItems = [
  { title: 'Medicines', icon: <MedicineIcon />, path: '/dashboard/pages/MedicineList' },
  { title: 'Add Medicine', icon: <AddIcon />, path: '/dashboard/pages/AddMedicine' },
  { title: 'Completed Orders', icon: <CompletedIcon />, path: '/dashboard/pages/completed' },
  { title: 'Pending Orders', icon: <PendingIcon />, path: '/dashboard/pages/pending' },
];
