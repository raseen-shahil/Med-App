...
export default function CheckoutScreen() {
  ...
  const validateForm = () => {
    ...
    if (!validatePostalCode(address.pincode)) {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      if (!orderData.userId || !orderData.items.length || !orderData.shippingAddress.fullName) {
      ...
      Alert.alert(
        'Error', 
        'Failed to place order. Please check all fields and try again.'
      );
    } finally {
