...
export default function ProductDetailScreen() {
  ...
  const handleWishlist = async () => {
    ...
    // Reference to wishlist item - this will create the subcollection if it doesn't exist
    const wishlistRef = doc(db, 'users', user.uid, 'wishlist', medicine.id);
    ...
    try {
      if (isInWishlist) {
        ...
        // This will automatically create the wishlist subcollection if it doesn't exist
